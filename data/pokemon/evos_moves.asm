...
; Learnset
	...
	db 22, HEADBUTT
	db 27, GROWL
	db 33, HYDRO_PUMP ;RIMPIAZZATA WATER_GUN Harzen 20/03/2023
...
; Learnset
	...
	db 36, STUN_SPORE
	db 39, SLEEP_POWDER
	db 45, MEGA_DRAIN ; RIMPIAZZATA SLAM 08/06/2025
	db 49, GROWTH
	db 0
...
; Learnset
	...
	db 43, RAZOR_LEAF ; RIMPIAZZATO GROWTH Harzen 18/03/2023
	db 55, SLEEP_POWDER
	db 65, LEECH_SEED ; RIMPIAZZATO SOLARBEAM Harzen 18/03/2023
	db 0
