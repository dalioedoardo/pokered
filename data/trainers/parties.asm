...
; Elia (aggiunto numero 9) harzen 18/03/2023
	db $FF, 98, MAGNETON, 100, AERODACTYL, 100, SCYTHER, 100, POLIWRATH, 100, GOLEM, 100, CHARIZARD, 0 ; ELIA harzen 17/03/2023
...
; NILOX: è il numero 15
	db $FF, 96, PRIMEAPE, 98, PERSIAN, 100, NIDOQUEEN, 100, GYARADOS, 100, PIDGEOT, 100, VENUSAUR, 0 ; NILOX harzen 17/03/2023
...
; Route 17
	...
	db $FF, 98, TENTACRUEL, 99, SLOWBRO, 100, MACHAMP, 100, EXEGGUTOR, 100, ARCANINE, 100, BLASTOISE, 0 ; LEO harzen 17/03/2023
...
GamblerData:
; Route 11
	db $FF, 94, DRAGONITE, 97, VICTREEBEL, 98, KABUTOPS, 100, JOLTEON, 100, ALAKAZAM, 100, CHARIZARD, 0 ; Edo Harzen 17/03/2023
