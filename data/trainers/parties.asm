...
LoreleiData:
	db $FF, 68, LAPRAS, 70, DEWGONG, 73, CLOYSTER, 74, JYNX, 76, JYNX, 78, LAPRAS, 0
...
AgathaData:
	db $FF, 76, GOLBAT, 78, GENGAR, 79, GOLBAT, 80, GENGAR, 82, GOLBAT, 85, GENGAR, 0

LanceData:
	db $FF, 78, GYARADOS, 80, DRAGONITE, 80, DRAGONITE, 80, DRAGONITE, 82, AERODACTYL, 85, DRAGONITE, 0
