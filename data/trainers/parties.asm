...
; Elia (aggiunto numero 9) harzen 18/03/2023
	db $FF, 100, MAGNETON, 100, AERODACTYL, 100, POLIWRATH, 100, GOLEM, 100, SCYTHER, 100, CHARIZARD, 0 ; ELIA harzen 17/03/2023
...
; Unused -> ORA LO USO PER PICCIA!!!
	db $FF, 100, LICKITUNG, 100, WIGGLYTUFF, 100, SNORLAX, 100, TANGELA, 100, GENGAR, 100, CHARIZARD, 0 ; PICCIA harzen 17/03/2023
; Silph Co. 2F
