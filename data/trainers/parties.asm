...
GamblerData:
; Route 11
	db $FF, 94, HYPNO, 97, VICTREEBEL, 98, KABUTOPS, 100, JOLTEON, 100, ALAKAZAM, 100, VENUSAUR, 0 ; Edo Harzen 17/03/2023
...
LtSurgeData:
	db $FF, 32, RAICHU, 34, ELECTRODE, 34, MAGNETON, 36, ELECTABUZZ, 40, 0
