...
; Elia (aggiunto numero 9) harzen 18/03/2023
	db $FF, 92, MAGNETON, 95, AERODACTYL, 96, POLIWRATH, 96, GOLEM, 98, SCYTHER, 100, CHARIZARD, 0 ; ELIA harzen 17/03/2023
...
; NILOX: è il numero 15
	db $FF, 92, PRIMEAPE, 95, PERSIAN, 95, NIDOQUEEN, 96, GYARADOS, 98, PIDGEOT, 100, VENUSAUR, 0 ; NILOX harzen 17/03/2023
...
; Route 17
	...
	db $FF, 92, TENTACRUEL, 93, SLOWBRO, 95, MACHAMP, 97, EXEGGUTOR, 98, ARCANINE, 100, BLASTOISE, 0 ; LEO harzen 17/03/2023
...
GamblerData:
; Route 11
	db $FF, 92, HITMONLEE, 94, JOLTEON, 96, KABUTOPS, 98, ALAKAZAM, 98, VICTREEBEL, 100, CHARIZARD, 0 ; Edo Harzen 17/03/2023
...
; Unused -> ORA LO USO PER PICCIA!!!
	db $FF, 92, LICKITUNG, 93, WIGGLYTUFF, 96, SNORLAX, 97, TANGELA, 99, GENGAR, 100, CHARIZARD, 0 ; PICCIA harzen 17/03/2023
; Silph Co. 2F
