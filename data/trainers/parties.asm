...
; Elia (aggiunto numero 9) harzen 18/03/2023
	db $FF, 100, MAGNETON, 100, AERODACTYL, 100, SCYTHER, 100, POLIWRATH, 100, GOLEM, 100, CHARIZARD, 0 ; ELIA harzen 17/03/2023
...
; NILOX: è il numero 15
	db $FF, 100, PRIMEAPE, 100, PERSIAN, 100, NIDOQUEEN, 100, GYARADOS, 100, PIDGEOT, 100, VENUSAUR, 0 ; NILOX harzen 17/03/2023
...
; Route 17
	...
	db $FF, 100, TENTACRUEL, 100, SLOWBRO, 100, MACHAMP, 100, EXEGGUTOR, 100, ARCANINE, 100, BLASTOISE, 0 ; LEO harzen 17/03/2023
...
GamblerData:
; Route 11
	db $FF, 100, HITMONLEE, 100, JOLTEON, 100, KABUTOPS, 100, ALAKAZAM, 100, VICTREEBEL, 100, CHARIZARD, 0 ; Edo Harzen 17/03/2023
...
Green1Data:
	...
	db 5, CHARMANDER, 0
; Route 22
	db $FF, 12, PIDGEY, 14, SQUIRTLE, 0
	db $FF, 12, PIDGEY, 14, BULBASAUR, 0
	db $FF, 12, PIDGEY, 14, CHARMANDER, 0
; Cerulean City
	db $FF, 19, PIDGEOTTO, 20, KADABRA, 21, RATICATE, 23, WARTORTLE, 0
	db $FF, 19, PIDGEOTTO, 20, KADABRA, 21, RATICATE, 23, IVYSAUR, 0
	db $FF, 19, PIDGEOTTO, 20, KADABRA, 21, RATICATE, 23, CHARMELEON, 0
...
ScientistData:
; Unused -> ORA LO USO PER PICCIA!!!
	db $FF, 100, PORYGON, 100, WIGGLYTUFF, 100, SNORLAX, 100, VILEPLUME, 100, GENGAR, 100, CHARIZARD, 0 ; PICCIA harzen 17/03/2023
; Silph Co. 2F
...
; Viridian Gym
	db $FF, 54, MAROWAK, 56, RHYDON, 58, GOLEM, 60, DUGTRIO, 64, NIDOQUEEN, 65, NIDOKING, 0
...
; Victory Road 3F
	db 43, EXEGGUTOR, SCYTHER, ARCANINE, 0
	db 43, PINSIR, TENTACRUEL, BLASTOISE, 0
; Unused
...
BrunoData:
	db $FF, 70, PRIMEAPE, 73, HITMONCHAN, 73, HITMONLEE, 74, POLIWRATH, 75, MACHAMP, 76, MACHAMP, 0

BrockData:
	db $FF, 12, OMANYTE, 12, KABUTO, 15, RHYHORN, 17, AERODACTYL, 0

MistyData:
	db $FF, 22, STARYU, 24, GYARADOS, 25, LAPRAS, 26, STARMIE, 0

LtSurgeData:
	db $FF, 32, RAICHU, 34, ELECTRODE, 34, MAGNETON, 36, ELECTABUZZ, 0

ErikaData:
	db $FF, 37, EXEGGUTOR, 39, TANGELA, 42, VICTREEBEL, 43, VENUSAUR, 44, VILEPLUME, 0

KogaData:
	db $FF, 45, ARBOK, 48, GOLBAT, 49, NIDOKING, 51, MUK, 53, WEEZING, 0

BlaineData:
	db $FF, 52, FLAREON, 54, MAGMAR, 56, NINETALES, 56, CHARIZARD, 58, RAPIDASH, 60, ARCANINE, 0

SabrinaData:
	db $FF, 47, STARMIE, 48, HYPNO, 48, SLOWBRO, 52, MR_MIME, 55, ALAKAZAM, 0
...
Green2Data:
; SS Anne 2F
  db $FF, 25, PIDGEOTTO, 27, GROWLITHE, 30, EXEGGCUTE, 30, KADABRA, 31, WARTORTLE, 0
  db $FF, 25, PIDGEOTTO, 27, GYARADOS, 30, GROWLITHE, 30, KADABRA, 31, IVYSAUR, 0
  db $FF, 25, PIDGEOTTO, 27, EXEGGCUTE, 30, GYARADOS, 30, KADABRA, 31, CHARMELEON, 0
; Pokémon Tower 2F
...
Green3Data:
	db $FF, 75, PIDGEOT, 77, ALAKAZAM, 78, RHYDON, 78, ARCANINE, 79, EXEGGUTOR, 82, BLASTOISE, 0
	db $FF, 75, PIDGEOT, 77, ALAKAZAM, 78, RHYDON, 78, GYARADOS, 79, ARCANINE, 82, VENUSAUR, 0
	db $FF, 75, PIDGEOT, 77, ALAKAZAM, 78, RHYDON, 78, EXEGGUTOR, 79, GYARADOS, 82, CHARIZARD, 0

LoreleiData:
	db $FF, 68, SLOWBRO, 70, DEWGONG, 71, CLOYSTER, 71, JYNX, 72, GOLDUCK, 73, LAPRAS, 0
...
AgathaData:
	db $FF, 72, GOLBAT, 74, PARASECT, 76, ARBOK, 76, MAROWAK, 77, GOLBAT, 78, GENGAR, 0

LanceData:
	db $FF, 74, GYARADOS, 76, DRAGONITE, 78, AERODACTYL, 78, DRAGONITE, 79, CHARIZARD, 80, DRAGONITE, 0
