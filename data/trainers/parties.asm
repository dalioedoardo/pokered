...
; Elia (aggiunto numero 9) harzen 18/03/2023
	db $FF, 90, MAGNETON, 92, AERODACTYL, 93, SCYTHER, 94, POLIWRATH, 96, GOLEM, 98, CHARIZARD, 0 ; ELIA harzen 17/03/2023
...
; NILOX: è il numero 15
	db $FF, 86, PRIMEAPE, 88, PERSIAN, 90, NIDOQUEEN, 91, GYARADOS, 92, PIDGEOT, 95, VENUSAUR, 0 ; NILOX harzen 17/03/2023
...
; Route 17
	...
	db $FF, 88, TENTACRUEL, 89, SLOWBRO, 90, MACHAMP, 93, EXEGGUTOR, 95, ARCANINE, 97, BLASTOISE, 0 ; LEO harzen 17/03/2023
...
GamblerData:
; Route 11
	db $FF, 84, HYPNO, 87, VICTREEBEL, 88, KABUTOPS, 90, JOLTEON, 91, ALAKAZAM, 93, VENUSAUR, 0 ; Edo Harzen 17/03/2023
...
; Unused -> ORA LO USO PER PICCIA!!!
	db $FF, 92, PORYGON, 93, WIGGLYTUFF, 96, SNORLAX, 97, VILEPLUME, 99, GENGAR, 100, CHARIZARD, 0 ; PICCIA harzen 17/03/2023
; Silph Co. 2F
...
BrunoData:
	db $FF, 70, PRIMEAPE, 73, HITMONCHAN, 74, HITMONLEE, 75, POLIWRATH, 78, MACHAMP, 82, MACHAMP, 0
...
Green3Data:
	db $FF, 81, PIDGEOT, 82, ALAKAZAM, 85, RHYDON, 87, ARCANINE, 89, EXEGGUTOR, 90, BLASTOISE, 0
	db $FF, 81, PIDGEOT, 82, ALAKAZAM, 85, RHYDON, 87, GYARADOS, 89, ARCANINE, 90, VENUSAUR, 0
	db $FF, 81, PIDGEOT, 82, ALAKAZAM, 85, RHYDON, 87, EXEGGUTOR, 89, GYARADOS, 90, CHARIZARD, 0

LoreleiData:
	db $FF, 68, SLOWBRO, 70, DEWGONG, 73, CLOYSTER, 74, JYNX, 76, GOLDUCK, 78, LAPRAS, 0
...
AgathaData:
	db $FF, 76, GOLBAT, 78, PARASECT, 79, ARBOK, 80, GENGAR, 82, GOLBAT, 85, GENGAR, 0

LanceData:
	db $FF, 78, GYARADOS, 80, DRAGONITE, 82, AERODACTYL, 80, DRAGONITE, 83, CHARIZARD, 85, DRAGONITE, 0
