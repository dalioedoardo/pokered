VictoryRoad2F_Object:
	...
	object_event  4,  5, SPRITE_SUPER_NERD, STAY, DOWN, 4, OPP_POKEMANIAC, 6 ;Harzen 02/04/2023 tolto supernerd vicino a moltres
	object_event 26,  3, SPRITE_SUPER_NERD, STAY, LEFT, 5, OPP_JUGGLER, 5
	object_event 12,  3, SPRITE_BIRD, STAY, UP, 6, MOLTRES, 50
