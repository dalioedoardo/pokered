Route17_Object:
	...
	object_event  8, 54, SPRITE_BIKER, STAY, RIGHT, 2, OPP_BIKER, 9 ; LEO Harzen 17/03/2023
	object_event  4, 18, SPRITE_BIKER, STAY, UP, 3, OPP_CUE_BALL, 5
	object_event  7, 32, SPRITE_BIKER, STAY, LEFT, 4, OPP_BIKER, 8
