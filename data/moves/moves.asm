...
; Characteristics of each move.
	...
	move KARATE_CHOP,  NO_ADDITIONAL_EFFECT,        80, FIGHTING,     100, 25
	...
	move VICEGRIP,     NO_ADDITIONAL_EFFECT,        95, BUG,          100, 30
	move GUILLOTINE,   OHKO_EFFECT,                  1, NORMAL,        30,  5
	move RAZOR_WIND,   CHARGE_EFFECT,              180, FLYING,        75, 10
	move SWORDS_DANCE, ATTACK_UP2_EFFECT,            0, NORMAL,       100, 30
	move CUT,          DEFENSE_DOWN_SIDE_EFFECT,    75, BUG,           95, 30
	...
	move STOMP,        FLINCH_SIDE_EFFECT2,         75, NORMAL,       100, 20
	...
	move HEADBUTT,     FLINCH_SIDE_EFFECT2,         85, NORMAL,       100, 15
	...
	move POISON_STING, POISON_SIDE_EFFECT1,         50, POISON,       100, 35
	move TWINEEDLE,    TWINEEDLE_EFFECT,            45, BUG,          100, 20
	move PIN_MISSILE,  TWO_TO_FIVE_ATTACKS_EFFECT,  24, BUG,           85, 20
	...
	move SUBMISSION,   RECOIL_EFFECT,              130, FIGHTING,      80, 25
	...
	move MEGA_DRAIN,   DRAIN_HP_EFFECT,             85, GRASS,        100, 10
	move LEECH_SEED,   LEECH_SEED_EFFECT,            0, GRASS,         90, 10
	move GROWTH,       SPECIAL_UP2_EFFECT,           0, NORMAL,       100, 40
	move RAZOR_LEAF,   NO_ADDITIONAL_EFFECT,        55, GRASS,         95, 25
	move SOLARBEAM,    CHARGE_EFFECT,              240, GRASS,        100, 10
	move POISONPOWDER, POISON_EFFECT,                0, POISON,        75, 35
	move STUN_SPORE,   PARALYZE_EFFECT,              0, GRASS,         75, 30
	move SLEEP_POWDER, SLEEP_EFFECT,                 0, GRASS,         75, 15
	move PETAL_DANCE,  THRASH_PETAL_DANCE_EFFECT,  120, GRASS,        100, 20
	move STRING_SHOT,  SPEED_DOWN1_EFFECT,           0, BUG,           95, 40
	move DRAGON_RAGE,  SPECIAL_DOWN_SIDE_EFFECT,   100, DRAGON,       100, 10
	...
	move SWIFT,        SWIFT_EFFECT,                60, FIRE,         100, 20
	move SKULL_BASH,   CHARGE_EFFECT,              200, ROCK,         100, 15
